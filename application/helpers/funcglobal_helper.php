...
function formGenerate($controller,$ListLabel,$lang_id,$lang_default){
        $html_output='';
        foreach($ListLabel as $label){
            if ($label['type_id']==1) { 
                $html_output .= ' <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-6">
                              <input name="'.$label['label_name'].$lang_id.'" type="text" class="form-control m-input" placeholder="'.$controller.' '.$label['label_title'].'" value="'.$label['content_text'].'">
                ...
                $html_output .= '<div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-10">
                            <textarea name="'.$label['label_name'].$lang_id.'" type="text" class="form-control m-input ckeditor" placeholder="section">
                            '.$label['content_text'].'                            
                            </textarea> 
                            <span class="m-form__help">
                              '.$label['label_notif'].'
                ...
                $html_output .= '<div class="form-group m-form__group row">
                                ...
                                <img id="img'.$label['label_name'].$lang_id.'" src="'.$content_image.'" style="max-width:400px; padding:5px; border:solid 1px #ccc;">                                   
                                </div>
                                   <input type="text" name="'.$label['label_name'].$lang_id.'" readonly="'.$label['label_name'].$lang_id.'" id="'.$label['label_name'].$lang_id.'" class="form-control" value="'.$content_image.'" onchange="getval(this);">
                                   <p class="help-block" style="color:#00F;">'.$label['label_notif'].'</p>
                                   <div style="margin-right:10px;">
                                    <a data-toggle="modal"  href="javascript:;" data-target="#Modal'.$label['label_name'].$lang_id.'" onClick="openKCFinder(&#39;'.$label['label_name'].$lang_id.'&#39;);" class="btn btn-outline-brand m-btn m-btn--icon m-btn--icon-only m-btn--outline-2x" id="link-file" class="link"><i class="flaticon-attachment"></i></a>
                                    <a class="btn btn-outline-brand m-btn m-btn--icon m-btn--icon-only m-btn--outline-2x" onClick="reset_value(&#39;'.$label['label_name'].$lang_id.'&#39;);" id="link-file" class="link"><i class="fa fa-refresh"></i></a>
                                   </div>
                                </div>
                             </div>';
                $html_output .='<div class="modal fade" id="Modal'.$label['label_name'].$lang_id.'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                ...
                $html_output .='<iframe class="filemanager" src="'.TOOLS_BASE_URL.'/filemanager/dialog.php?type=1&field_id='.$label['label_name'].$lang_id.'&#39;&akey=2063c1608d6e0baf80249c42e2be5804&fldr=" frameborder="0" style="overflow: scroll; overflow-x: hidden; overflow-y: scroll; "></iframe>
                                        </div>
                                        </div>
                                </div>
                </div>'; 
             ...
             else if ($label['type_id']==4 && $lang_default==1) { 
                $html_output .= '<div class="form-group m-form__group row">
                                        <label class="col-lg-2 col-form-label">
                                                '.$controller.' '.$label['label_title'].':
                                        </label>
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                                <div class="input-group date" >
                                                        <input type="text" name="'.$label['label_name'].$lang_id.'"  class="form-control m-input" readonly  value="'.$label['content_text'].'" id="m_datepicker_3"/>
            ...
            else if ($label['type_id']==5 && $lang_default==1) { 
                $html_output .= '<div class="form-group m-form__group row">
                                        <label class="col-lg-2 col-form-label">
                                               '.$controller.' '.$label['label_title'].':
                                        </label>
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                                <div class="input-group timepicker">
                                                        <input type="text" name="'.$label['label_name'].$lang_id.'" id="m_timepicker_2_modal" class="form-control m-input" readonly placeholder="Select time" type="text"/ value="'.$label['content_text'].'">
                                                        <div class="input-group-append">
                                                                <span class="input-group-text">
            ...
            else if ($label['type_id']==6 && $lang_default==1) { 
                $html_output .= '<div class="form-group m-form__group row">
                                        <label class="col-lg-2 col-form-label">
                                               '.$controller.' '.$label['label_title'].':
                                        </label>
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                        <select  name="'.$label['label_name'].$lang_id.'" class="form-control m-input">
                    ...
                    foreach ($label['options'] as $opt) {
                        ...
                        $html_output .= '</select>
                                ...
                                <span class="m-form__help">
                              '.html_entity_decode($label['label_notif']).'
                              </span>
                                </div>';
            }
            
            else if ($label['type_id']==7 && $lang_default==1) { 
               $html_output .= '<div class="form-group m-form__group row">';
                    ...
                    $html_output .= ': </label>';               
                                      $html_output .= '<div class="col-lg-4 col-md-9 col-sm-12 m-radio-inline">';
                                        ...
                                        $html_output .= '<label class="m-radio">';
                                                      $html_output .= '<input type="radio" name="'.$label['label_name'].$lang_id.'" value="'.$opt['options_id'].'" "'.(($opt['options_id'] == $label['content_text'])?' checked ':"").'">';
                                      ...
                                      $html_output .= '<span class="m-form__help">';
                                        $html_output .= html_entity_decode($label['label_notif']);
                                      $html_output .= '</span>';
                              $html_output .= '</div>';
              }
                ...
                $html_output .= ' <div class="form-group m-form__group row" style="display:none;">
                           ...
                           <div class="col-lg-6">
                              <input readonly name="'.$label['label_name'].$lang_id.'" type="text" class="form-control m-input" placeholder="'.$controller.' '.$label['label_title'].'" value="'.$label['label_title'].'">
                              <span class="m-form__help">
                              '.$label['label_notif'].'
                              </span>
                           </div>
            ...
            else if ($label['type_id']==9 && $lang_default==1) { 
                $html_output .= '<div class="form-group m-form__group row">
                                <label class="col-lg-2 col-form-label">
                                               '.$controller.' '.$label['label_title'].':
                                </label>
                                ...
                                <div class="m-checkbox-list">';
                                    ...
                                    $html_output .= ' <label class="m-checkbox">
                                     <input value="'.$opt['options_id'].'" name="'.$label['label_name'].$lang_id.'[]" type="checkbox" "'.((in_array($opt['options_id'], $opts))?' checked ':"").'">
                                     '.$opt['options_title'].'
                                     <span></span>
                                     </label>'; 
                                    }  
                ...
                $html_output .= '<div class="form-group m-form__group row">
                                ...
                                <div style="margin-bottom:10px;" class="'.$label['label_name'].'">
                                  <i class="icon--lg flaticon-open-box"></i>                        
                                   ...
                                   <input type="text" name="'.$label['label_name'].$lang_id.'" readonly="'.$label['label_name'].$lang_id.'" id="'.$label['label_name'].$lang_id.'" class="form-control" value="'.$content_file.'">
                                   <p class="help-block" style="color:#00F;">'.$label['label_notif'].'</p>
                                   <div style="margin-right:10px;">
                                    <a data-toggle="modal"  href="javascript:;" data-target="#Modal'.$label['label_name'].$lang_id.'" onClick="openKCFinder(&#39;'.$label['label_name'].$lang_id.'&#39;);" class="btn btn-outline-brand m-btn m-btn--icon m-btn--icon-only m-btn--outline-2x" id="link-file" class="link"><i class="flaticon-attachment"></i></a>
                                    <a class="btn btn-outline-brand m-btn m-btn--icon m-btn--icon-only m-btn--outline-2x" onClick="reset_value(&#39;'.$label['label_name'].$lang_id.'&#39;);" id="link-file" class="link"><i class="fa fa-refresh"></i></a>
                ...
                $html_output .='<div class="modal fade" id="Modal'.$label['label_name'].$lang_id.'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                                <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">'; 
                $html_output .='<iframe class="filemanager" src="'.TOOLS_BASE_URL.'/filemanager/dialog.php?type=3&field_id='.$label['label_name'].$lang_id.'&#39;&akey=2063c1608d6e0baf80249c42e2be5804&fldr=" frameborder="0" style="overflow: scroll; overflow-x: hidden; overflow-y: scroll; "></iframe>
                                        </div>
                                        </div>
                                </div>
                </div>'; 
...
if( ! function_exists('formGenerateLang')){
    function formGenerateLang($controller,$ListLabel,$lang_id,$lang_default){
            $html_output='';
            foreach($ListLabel as $label){
                $getLangContent =  getTextLang($label['row_id'], $label['label_id'], $lang_id, $label['content_text']);
                if ($label['type_id']==1) { 
                    $html_output .= ' <div class="form-group m-form__group row">
                               <label class="col-lg-2 col-form-label">
                                '.$controller.' '.$label['label_title'].':
                               ...
                               <div class="col-lg-6">
                                  <input name="'.$label['label_name'].$lang_id.'" type="text" class="form-control m-input" placeholder="'.$controller.' '.$label['label_title'].'" value="'.$getLangContent.'">
                                  <span class="m-form__help">
                                  '.$label['label_notif'].'
                                  </span>
                               </div>
                    ...
                    $content_image_thumbs = BASE_URL.str_replace('/admin','/admin/.thumbs',$getLangContent);
                    $content_image = BASE_URL.$getLangContent;
                    $html_output .= '<div class="form-group m-form__group row">
                                    <label class="col-lg-2 col-form-label">
                                     '.$controller.' '.$label['label_title'].':
                                    </label>
                   ...
                   $html_output .= '<div class="form-group m-form__group row">';
                    ...
                    $content_file_thumbs = BASE_URL('/admin'.$getLangContent);
                    $content_file = BASE_URL.$getLangContent;
                    $html_output .= '<div class="form-group m-form__group row">
                                    <label class="col-lg-2 col-form-label">
                                     '.$controller.' '.$label['label_title'].':
                                    </label>
                    ...
                    $html_output .='<div class="modal fade" id="Modal'.$label['label_name'].$lang_id.'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                                    <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">'; 
                    $html_output .='<iframe class="filemanager" src="'.TOOLS_BASE_URL.'/filemanager/dialog.php?type=0&field_id='.$label['label_name'].$lang_id.'&#39;&akey=2063c1608d6e0baf80249c42e2be5804&fldr=" frameborder="0" style="overflow: scroll; overflow-x: hidden; overflow-y: scroll; "></iframe>
                                            </div>
                                            </div>
                                    </div>
                    </div>'; 
...
if( ! function_exists('getTextLang')){
        function getTextLang($row_id, $label_id,$lang_id,$content){
            $db =& DB();
            $query = $db->get_where('tbl_content_lang',array('row_id' => $row_id,'language_id' => $lang_id,'label_id' => $label_id));
