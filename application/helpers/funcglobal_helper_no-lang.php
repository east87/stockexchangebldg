...
function formGenerate($controller,$ListLabel){
        ...
        foreach($ListLabel as $label){
            if ($label['type_id']==1) { 
                ...
                $html_output .='<iframe class="filemanager" src="'.TOOLS_BASE_URL.'/filemanager/dialog.php?type=1&field_id='.$label['label_name'].'&#39;&akey=2063c1608d6e0baf80249c42e2be5804&fldr=" frameborder="0" style="overflow: scroll; overflow-x: hidden; overflow-y: scroll; "></iframe>
                                        </div>
                                        </div>
                                </div>
                </div>'; 
...
function formGenerateLang($controller,$ListLabel){
        $html_output='';
        foreach($ListLabel as $label){
            if ($label['type_id']==1) { 
                $html_output .= ' <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-6">
                              <input name="'.$label['label_name'].'" readonly type="text" class="form-control m-input" placeholder="'.$controller.' '.$label['label_title'].'" value="'.$label['content_text'].'">
                              <span class="m-form__help">
                              '.$label['label_notif'].'
                              </span>
                           </div>
                ...
                $html_output .= '<div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-10">
                            <textarea name="'.$label['label_name'].'" readonly type="text" class="form-control m-input ckeditor" placeholder="section">
                            '.$label['content_text'].'                            
                            </textarea> 
                            <span class="m-form__help">
                              '.$label['label_notif'].'
                ...
                $html_output .= '<div class="form-group m-form__group row">
                                ...
                                <img src="'.$content_image.'" style="max-width:400px; padding:5px; border:solid 1px #ccc;">                                   
                                </div>
                ...
                $html_output .= '<div class="form-group m-form__group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                                <div class="input-group date" >
                                                        <input readonly type="text" name="'.$label['label_name'].'"  class="form-control m-input" readonly  value="'.$label['content_text'].'"/>
                ...
                $html_output .= '<div class="form-group m-form__group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                                <div class="input-group timepicker">
                                                        <input readonly type="text" name="'.$label['label_name'].'"  class="form-control m-input" readonly placeholder="Select time" type="text"/ value="'.$label['content_text'].'">
               ...
               $html_output .= '<div class="form-group m-form__group row">';
                    ...
                    $html_output .= ': </label>';               
                                      $html_output .= '<div class="col-lg-4 col-md-9 col-sm-12 m-radio-inline">';
                                         foreach ($label['options'] as $opt) {        
                                        $html_output .= '<label class="m-radio">';
                                                      $html_output .= '<input disabled  type="radio" name="'.$label['label_name'].'" value="'.$opt['options_id'].'" "'.(($opt['options_id'] == $label['content_text'])?' checked ':"").'">';
                                                     $html_output .= $opt['options_title'];
                                                      $html_output .= '<span></span>';
                                              $html_output .= '</label>';
                                                }  
