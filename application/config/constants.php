...
define('PROJECT_TITLE', 'Indonesia Stock Exchange Building');
...
define('VIDEO_BASE_URL', BASE_URL.'/assets/video');
...
define('MAIL_CONT', 'enquiries@fji.co.id');
define('MAIL_CC', 'hl.prba87@gmail.com');