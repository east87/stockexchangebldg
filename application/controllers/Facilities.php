...
class Facilities extends MY_Controller {
...

	{
		...
		$this->load->helper(array('funcglobal','menu','accessprivilege','alias','text'));
                ...
                $this->data["module_header"]=130;
                $this->data["module_page"]=133;
                $this->data["module_subpage"]=141;
	...
	{
            $this->data["page_title"]=$this->lang->line("facilities");
		...
		$this->data["ListSubPage"] = $ListSubPage;
            ...
            $this->load->view('vfacilities',$this->data);
	}
