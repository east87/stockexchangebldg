...
<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
               ...
               <div class="d-flex align-items-center">
                  <div class="mr-auto">
                     <h3 class="m-subheader__title m-subheader__title--separator">
                        <?php echo $breadcrump['module_group_name']; ?> - <?php echo $breadcrump['module_name']; ?> -  ADD Lang <?=$Lang?>
                     </h3>
                  </div>
               </div>
            </div>
            ...
            <div class="m-content">
               <div class="m-portlet">
                  <!--begin::Form-->
                    ...
                    <?php echo formGenerateLang($controller,$rsContent);?> 
                     
                  <!--end::Form-->
                  </div>
                  
                  
                  <form name="form1" action="<?php echo BASE_URL_BACKEND.'/'.$controller.'/doAddLang'; ?>" method="post" role="form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator">
                     <?php if(isset($error)){ ?>
                     ...
                     <?php } ?>  
                   <input readonly type="hidden" name="language_id"  class="form-control m-input" readonly  value="<?=$language_id?>"/>
                   <input readonly type="hidden" name="row_id"  class="form-control m-input" readonly  value="<?=$row_id?>"/>
                   
                     <div class="m-portlet__body">
                    <?php echo formGenerate($controller,$ListLabel);?> 
   ...
   <script language="javascript">
      ...
      if(answer){
      frm.action = '<?php echo BASE_URL_BACKEND;?>/about/doOrder';
      frm.submit();
      } else {
      return false;
      }
